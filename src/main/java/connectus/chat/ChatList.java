...
public class ChatList {
	...
	public ChatList(int id, int pr_id, String sellerId, String buyerId, String fileName, String createdDate,
			String content, String sendTime, String senderId, String pr_title, String img1, String img2, String img3, String img4, String img5, String img6, int chatReadBuy, int chatReadSell) {
		super();
		this.id = id;
		this.pr_id = pr_id;
